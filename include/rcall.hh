...
public:
	...
	const std::vector<std::string> &getFunctionArgsName() const
	{
		return this->functionargs;
	}

	void cleanFunctionArgNames()
	{
...
{
public:
	explicit RCoreRuntime() : rCode(nullptr), rArgument(nullptr), rFunc(nullptr), rResults(nullptr)
	{
		this->runType = R;
	};
